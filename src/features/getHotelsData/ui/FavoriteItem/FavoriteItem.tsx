...
interface Props {
    hotel: FavoriteHotelType
}

export const FavoriteItem: React.FC<Props> = memo((props) => {
    const { stars, hotelName, priceAvg, date, days, hotelId } = props.hotel
            ...
            <div className={styles.favorite_item}>
                <div className={styles.info_area}>
                    <div className={styles.favorite_info}>
                        <div className={styles.favorite_name}>{hotelName}</div>
                        <div className={styles.favorite_date}>
                            <span>{date}</span>
                        ...
                        <div className={styles.favorite_stars}>
                            {goldStars}
                            {grayStars}
                        </div>
                    </div>
                ...
                <div className={styles.price_area}>
                    ...
                    <div className={styles.favorite_price}>
                        <span>Price:</span>
                        {priceAvg.toFixed(0)} ₽
                    </div>
                </div>
